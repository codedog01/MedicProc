package com.yibai.medicproc.common.utils.http;
...
public class HttpUtils
{
    ...
    {
        return sendGet(url, param, Constants.UTF8,new HashMap<>());
    }
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendGet(String url, String param, String contentType, Map<String, String> headerMap)
    {
